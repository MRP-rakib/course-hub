        ...
        <Container className="relative py-16 md:py-20 lg:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <Link
                href="/join"
                className="inline-flex items-center justify-center rounded-xl border border-white/1 bg-white/3 px-5 py-3 text-sm font-semibold text-white/80 transition-colors hover:border-white/16 hover:bg-white/6 hover:text-white"
              >
                Join the hub
              </Link>
            </div>
        ...
        <Container>
          ...
          <div className="mx-auto mt-10 grid max-w-5xl grid-cols-1 gap-4 sm:grid-cols-2">
            {values.map(({ title, body, icon: Icon }) => (
              <article
                key={title}
                className="rounded-2xl border border-white/8 bg-white/2 p-5 transition-colors hover:border-violet-500/25 hover:bg-violet-500/4"
              >
        ...
        <Container>
          <div className="mx-auto max-w-2xl rounded-2xl border border-violet-500/25 bg-linear-to-br from-violet-600/15 to-purple-600/10 px-6 py-10 text-center md:px-10">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link
                href="/join"
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-linear-to-r from-violet-600 to-purple-600 px-5 py-3 text-sm font-bold tracking-wide text-white transition-opacity hover:opacity-90 sm:w-auto"
              >
                Get started
                <ArrowRight size={16} />
              </Link>
              <Link
                href="/instructors"
                className="inline-flex w-full items-center justify-center rounded-xl border border-white/12 bg-white/5 px-5 py-3 text-sm font-semibold text-white/90 transition-colors hover:bg-white/8 sm:w-auto"
              >
                Meet instructors
              </Link>
            </div>
