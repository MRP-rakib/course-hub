  ...
  return (
    <div className="relative min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4 py-12 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-linear(rgba(255,255,255,0.03) 1px, transparent 1px), linear-linear(90deg, rgba(255,255,255,0.03) 1px, transparent 1px)",
      ...
      <div className="relative w-full max-w-lg text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Link
            href="/student/signup"
            className="group relative flex flex-col items-center text-center rounded-2xl border border-white/8 bg-white/4 p-8 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-violet-500/40 hover:shadow-[0_16px_48px_rgba(91,79,255,0.15)] overflow-hidden"
          >
            <div className="absolute top-0 left-[15%] right-[15%] h-px bg-linear-to-r from-transparent via-violet-500/50 to-transparent" />
          ...
          <Link
            href="/teacher/signup"
            className="group relative flex flex-col items-center text-center rounded-2xl border border-white/8 bg-white/4 p-8 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-pink-500/40 hover:shadow-[0_16px_48px_rgba(244,114,182,0.15)] overflow-hidden"
          >
            <div className="absolute top-0 left-[15%] right-[15%] h-px bg-linear-to-r from-transparent via-pink-500/50 to-transparent" />
